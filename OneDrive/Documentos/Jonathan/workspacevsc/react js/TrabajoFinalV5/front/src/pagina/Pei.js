...
import '../estilos/componentes/pagina/Pei.css';
    ...
    return (
        <main className="holder-main">
            <motion.div
                ...
                className="pei"
            >
                <h1 className="titulo-aic-pei">Titutlo del pei</h1>
                <h2>Sutitulo</h2>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorem cupiditate vitae iusto libero,
                    expedita architecto dolorum quae nesciunt aspernatur deserunt, voluptatum delectus illum? Maxime repellendus perferendis illum quam dolores eum.</p>
